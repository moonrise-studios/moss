...
This file is the GitHub Copilot runtime entrypoint for this repository.
...
- Copilot project agents: `.github/agents/*.agent.md`
...
- Copilot custom agents live in `.github/agents/`
- Keep Copilot runtime prompts aligned with the shared baseline instead of drifting into Copilot-only behavior
