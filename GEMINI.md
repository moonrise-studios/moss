...
This file is the Gemini CLI runtime entrypoint for this repository.
...
- Gemini project subagents: `.gemini/agents/*.md`
- Copilot mirrors: `.github/agents/*.agent.md`
- Claude mirrors: `.claude/agents/*.md`
...
- Gemini loads `GEMINI.md` hierarchically; keep this root file aligned with `AGENTS.md`
- Gemini project subagents are markdown files with YAML frontmatter in `.gemini/agents/`
